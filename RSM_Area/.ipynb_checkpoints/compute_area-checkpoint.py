...
if __name__ == '__main__':
    ...
    MESHNAME = "CHAMP_final_ascii.stl"   #MESH FILENAME
    SATNAME = "CHAMP"                    #SATELLITE NAME
    NPROCS = 4                           #NUMBER OF PROCESSORS

    dphi = 0.1                            #PITCH ANGLE RESOLUTION (IN DEGREES)
    dtheta = 0.1                          #YAW ANGLE RESOLUTION (IN DEGREES)

    phi_min = -5.0                         #MINIMUM PITCH ANGLE (IN DEGREES)
    phi_max = 5.0                        #MAXIMUM PITCH ANGLE (IN DEGREES)
    theta_min = -10.0                       #MINIMUM YAW ANGLE (IN DEGREES)
    theta_max = 10.0                       #MAXIMUM YAW ANGLE (IN DEGREES)
